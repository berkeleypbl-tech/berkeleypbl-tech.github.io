(function ($) {
	...
	var json = [[['Autumn Wang', 'Amy Yang', 'Armaan Tiwana', 'Amy Zhong'], ['Cathy Zhang', 'Dylan Huynh', 'Deepa Kori', 'Dennis Pham'], ['Alvin Han', 'Matthew Ahn', 'Dyllan Liu', 'Kate Ngo'], ['Somi Kim', 'Jason Tao', 'Coco Sun', 'Angela Jiang']], [['Carrie Liu', 'Alice Han', 'Andrew Huang', 'Christine Liu'], ['Bradly Wei', 'Stephen Yang', 'Xiaojing (Ivy) Lei'], ['Eddie Liu', 'Josie Nieh', 'Ethan Chang', 'Alexandra Koullick'], ['Monica Zhang', 'Ashwin Iyer', 'Jennifer Lopez Garcia', 'Hitansh Nagdev']], [['Alex Lavoie', 'Lilly Lim', 'Julen Velasquez', 'Susanna Huang'], ['Eden Chun', 'Riya Sheik', 'Ritvik Kandarkar', 'Cassidy Cho'], ['Charles Van', 'Brandon Hong', 'Liam Patel', 'Hamayl Cheema'], ['Isabella Pang', 'Justin Oh', 'Adam An', 'Alyson Chang']], [['Clairine Wantah', 'Monel Tse', 'Gabe Deng', 'Grace Chi'], ['Kai Chen', 'Victoria Peng', 'Hayley Lai', 'Varun Agrawal'], ['Jeremy Mui', 'Christie Lum', 'Nikitha Sridhar', 'Elliot Yu'], ['Max Kim', 'Nathan Setokusumo', 'Erika Yang', 'Priscilla Chang']]];
