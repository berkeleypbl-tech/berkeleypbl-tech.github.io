(function ($) {
	...
	var json = [[['Amy Zhong', 'Grace Chi', 'Riya Sheik', 'Armaan Tiwana'], ['Dennis Pham', 'Nikitha Sridhar', 'Kate Ngo', 'Susanna Huang'], ['Carrie Liu', 'Brandon Hong', 'Stephen Yang', 'Josie Nieh'], ['Cassidy Cho', 'Amy Yang', 'Coco Sun', 'Xiaojing (Ivy) Lei']], [['Christine Liu', 'Isabella Pang', 'Liam Patel'], ['Autumn Wang', 'Hayley Lai', 'Lilly Lim', 'Matthew Ahn'], ['Alvin Han', 'Julen Velasquez', 'Alice Han', 'Eddie Liu'], ['Somi Kim', 'Max Kim', 'Ashwin Iyer']], [['Kai Chen', 'Christie Lum', 'Alex Lavoie', 'Deepa Kori'], ['Andrew Huang', 'Jason Tao', 'Dylan Huynh', 'Eden Chun'], ['Charles Van', 'Gabe Deng', 'Ethan Chang', 'Adam An'], ['Hamayl Cheema', 'Justin Oh', 'Monica Zhang', 'Erika Yang']], [['Clairine Wantah', 'Monel Tse', 'Alexandra Koullick', 'Alyson Chang'], ['Bradly Wei', 'Ritvik Kandarkar', 'Elliot Yu', 'Varun Agrawal'], ['Cathy Zhang', 'Dyllan Liu', 'Jeremy Mui', 'Victoria Peng'], ['Hitansh Nagdev', 'Angela Jiang', 'Nathan Setokusumo', 'Priscilla Chang']]];
