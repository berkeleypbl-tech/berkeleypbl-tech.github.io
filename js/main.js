(function ($) {
	...
	var json = [[['Darren Kim', 'James Yoo', 'Alice Chen'], ['Roger Zhang', 'Christine Liu', 'Bianca Tam', 'Bradly Wei'], ['Kate Ngo', 'Priscilla Chang', 'Hamayl Cheema', 'Hitansh Nagdev'], ['Justin Quan', 'Jaemin Woo', 'Jessica Wang']], [['Sydney Ty', 'Coco Sun', 'Cathy Zhang'], ['Michelle Lin', 'Vien Yen Ho Pham', 'Andy Varela'], ['Brenton Law', 'Albert Tran'], ['Emily Zhu', 'Ethan Chien', 'Tiffany Feng']], [['Austin Kim', 'Autumn Wang', 'Monica Zhang'], ['Jackie Cai', 'Aman Patel', 'Emily Lu'], ['Jeremy Mui', 'Andrew Huang', 'Dyllan Liu'], ['Kai Chen', 'Hannah Shever', 'Conor Richard']], [['Kaci Gu', 'Chloe Guo', 'Carrie Liu'], ['Angela Jiang', 'Amy Zhong', 'Somi Kim'], ['Abby Tan', 'Charles Van', 'Ryan Fung', 'Liam Patel'], ['Henry Cheong', 'Milleno Pan', 'Justin Kim']], [['Dennis Pham', 'Maryam Kazi', 'Nicole Kim', 'Nikita Rahman'], ['Nicholas Paul', 'Cassidy Cho', 'Alexandre Lavoie', 'Adam Sun'], ['Grace Chi', 'Max Kim', 'Edward Liu'], ['Claire Yoon', 'Alvin Han', 'Erika Yang']]];
