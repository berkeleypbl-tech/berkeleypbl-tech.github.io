(function ($) {
	...
	var json = [[['Christine Liu', 'Armaan Tiwana', 'Julen Velasquez', 'Ritvik Kandarkar'], ['Kate Ngo', 'Jason Tao', 'Amy Zhong', 'Max Kim'], ['Hitansh Nagdev', 'Dylan Huynh', 'Susanna Huang', 'Charles Van'], ['Angela Jiang', 'Justin Oh', 'Clairine Wantah', 'Brandon Hong']], [['Andrew Huang', 'Stephen Yang', 'Liam Patel', 'Alyson Chang'], ['Kai Chen', 'Josie Nieh', 'Varun Agrawal', 'Matthew Ahn'], ['Cathy Zhang', 'Isabella Pang', 'Ethan Chang', 'Xiaojing (Ivy) Lei'], ['Eden Chun', 'Amy Yang', 'Nathan Setokusumo', 'Ashwin Iyer']], [['Alex Lavoie', 'Alexandra Koullick', 'Riya Sheik'], ['Eddie Liu', 'Deepa Kori', 'Somi Kim', 'Hamayl Cheema'], ['Dennis Pham', 'Grace Chi', 'Adam An', 'Alvin Han'], ['Priscilla Chang', 'Monica Zhang', 'Cassidy Cho', 'Victoria Peng']], [['Carrie Liu', 'Christie Lum', 'Alice Han', 'Lilly Lim'], ['Bradly Wei', 'Elliot Yu', 'Hayley Lai'], ['Jeremy Mui', 'Gabe Deng', 'Nikitha Sridhar', 'Dyllan Liu'], ['Autumn Wang', 'Coco Sun', 'Monel Tse', 'Erika Yang']]];
