(function ($) {
	...
	var json = [[['Clairine Wantah', 'Amy Yang', 'Deepa Kori', 'Lilly Lim'], ['Dennis Pham', 'Amy Zhong', 'Max Kim', 'Josie Nieh'], ['Kate Ngo', 'Brandon Hong', 'Ethan Chang', 'Alice Han'], ['Grace Chi', 'Coco Sun', 'Julen Velasquez', 'Angela Jiang']], [['Christine Liu', 'Bradly Wei', 'Alexandra Koullick'], ['Autumn Wang', 'Hayley Lai', 'Stephen Yang', 'Riya Sheik'], ['Cathy Zhang', 'Nikitha Sridhar', 'Alyson Chang', 'Christie Lum'], ['Hitansh Nagdev', 'Armaan Tiwana', 'Justin Oh', 'Ashwin Iyer']], [['Carrie Liu', 'Ritvik Kandarkar', 'Susanna Huang', 'Jason Tao'], ['Somi Kim', 'Matthew Ahn', 'Dylan Huynh', 'Cassidy Cho'], ['Eden Chun', 'Alvin Han', 'Varun Agrawal', 'Charles Van'], ['Alex Lavoie', 'Priscilla Chang', 'Hamayl Cheema', 'Adam An']], [['Andrew Huang', 'Monel Tse', 'Gabe Deng'], ['Kai Chen', 'Elliot Yu', 'Xiaojing (Ivy) Lei', 'Liam Patel'], ['Eddie Liu', 'Jeremy Mui', 'Isabella Pang', 'Victoria Peng'], ['Monica Zhang', 'Dyllan Liu', 'Nathan Setokusumo', 'Erika Yang']]];
