(function ($) {
	...
	var json = [[['Darren Kim', 'Hannah Shever', 'Jaemin Woo'], ['Claire Yoon', 'Monica Zhang', 'Andrew Huang'], ['Nicholas Paul', 'Priscilla Chang', 'Edward Liu'], ['Justin Quan', 'Nicole Kim', 'Adam Sun']], [['Jackie Cai', 'Cathy Zhang', 'Alexandre Lavoie'], ['Bradly Wei', 'Vien Yen Ho Pham', 'Somi Kim', 'Charles Van'], ['Kate Ngo', 'Maryam Kazi', 'Dyllan Liu'], ['Erika Yang', 'Justin Kim', 'Conor Richard']], [['Dennis Pham', 'Ryan Fung', 'Hamayl Cheema'], ['Grace Chi', 'Milleno Pan', 'Ethan Chien'], ['Brenton Law', 'Chloe Guo', 'Jeremy Mui', 'Hitansh Nagdev'], ['Kai Chen', 'Autumn Wang', 'Alvin Han']], [['Henry Cheong', 'Carrie Liu', 'Andy Varela', 'Liam Patel'], ['Michelle Lin', 'Aman Patel', 'Amy Zhong'], ['Abby Tan', 'James Yoo', 'Albert Tran'], ['Emily Zhu', 'Max Kim', 'Jessica Wang', 'Emily Lu']], [['Alice Chen', 'Bianca Tam', 'Nikita Rahman'], ['Kaci Gu', 'Angela Jiang', 'Christine Liu'], ['Roger Zhang', 'Austin Kim', 'Coco Sun'], ['Sydney Ty', 'Cassidy Cho', 'Jason Tao']]];
