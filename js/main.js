(function ($) {
	...
	var json = [[['Alice Chen', 'Chloe Guo', 'Andy Varela', 'Amy Zhong'], ['Claire Yoon', 'Christine Liu', 'Milleno Pan'], ['Brenton Law', 'Priscilla Chang', 'Vien Yen Ho Pham'], ['Justin Quan', 'Autumn Wang', 'Hannah Shever', 'Bianca Tam']], [['Austin Kim', 'Liam Patel', 'James Yoo'], ['Michelle Lin', 'Carrie Liu', 'Darren Kim'], ['Abby Tan', 'Aman Patel', 'Dyllan Liu'], ['Henry Cheong', 'Erika Yang', 'Conor Richard']], [['Kaci Gu', 'Ethan Chien', 'Ryan Fung'], ['Grace Chi', 'Jessica Wang', 'Andrew Huang'], ['Nicholas Paul', 'Nikita Rahman', 'Jaemin Woo', 'Hitansh Nagdev'], ['Kai Chen', 'Adam Sun', 'Hamayl Cheema']], [['Jackie Cai', 'Cathy Zhang', 'Monica Zhang'], ['Roger Zhang', 'Alvin Han', 'Somi Kim'], ['Kate Ngo', 'Albert Tran', 'Charles Van'], ['Angela Jiang', 'Justin Kim', 'Coco Sun']], [['Dennis Pham', 'Emily Lu', 'Sydney Ty'], ['Bradly Wei', 'Maryam Kazi', 'Cassidy Cho', 'Max Kim'], ['Jeremy Mui', 'Alexandre Lavoie', 'Jason Tao'], ['Emily Zhu', 'Edward Liu', 'Nicole Kim']]];
