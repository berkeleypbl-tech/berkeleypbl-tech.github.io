(function ($) {
	...
	var json = [[['Nicholas Paul', 'Kaci Gu', 'Janet Xu'], ['Kai Chen', 'Junru Lyu', 'David Wang'], ['Cyssi Ngo', 'Kristy Kao', 'Kate Ngo', 'Bradley Wei'], ['Claire Yoon', 'Brandy Nguyen', 'Sydney Ty']], [['Anthony Chen', 'George Lee', 'Monica Zhang'], ['Emily Zhu', 'Corey Gibbel', 'Cathy Zhang'], ['Henry Cheong', 'Celine Birkl', 'Autumn Wang'], ['Emily Jin', 'Sarah Shin', 'Angela Jiang']], [['Tiffany Chung', 'Max Larsen', 'Grace Li'], ['Michelle Lin', 'Jenny Bong', 'Roger Zhang'], ['Samantha Fang', 'Amy Zhong', 'Hitansh Nagdev', 'Tiffany Feng'], ['Sehee Park', 'Margaret Lee', 'Khoa Pham']], [['Stella Kim', 'Nina Tagliabue', 'Patricia Tse'], ['Jacqueline Zhang', 'Carrington Park', 'Vien Yen Ho Pham'], ['Jeremy Mui', 'Chloe Guo', 'Vaibhav Gattani', 'Dennis Pham'], ['Alan Dai', 'Erika Yang', 'Christine Oh', 'Tarun Sreedhar']], [['Grace Chi', 'Carl Qi', 'Hannah Shever'], ['Jackie Hu', 'Christine Liu', 'Justin Quan', 'Ethan Yoon'], ['Brenton Law', 'Conor Richard', 'Darren Kim', 'Priscilla Chang'], ['Alice Chen', 'Charles Van', 'Dylan Asprer']]];
