(function ($) {
	...
	var json = [[['Nicholas Paul', 'Nina Tagliabue', 'Grace Li', 'Kaci Gu'], ['Jackie Hu', 'Junru Lyu', 'Janet Xu', 'Roger Zhang'], ['Grace Chi', 'Vaibhav Gattani', 'Erika Yang'], ['Brenton Law', 'Dylan Asprer', 'Claire Yoon', 'Brandy Nguyen']], [['Emily Jin', 'George Lee', 'David Wang', 'Celine Birkl'], ['Kristy Kao', 'Cathy Zhang', 'Stella Kim'], ['Anthony Chen', 'Priscilla Chang', 'Alan Dai'], ['Emily Zhu', 'Chloe Guo', 'Angela Jiang']], [['Sehee Park', 'Max Larsen', 'Dennis Pham', 'Ethan Yoon'], ['Michelle Lin', 'Christine Liu', 'Hannah Shever'], ['Samantha Fang', 'Tiffany Feng'], ['Alice Chen', 'Autumn Wang', 'Khoa Pham']], [['Henry Cheong', 'Patricia Tse', 'Christine Oh', 'Monica Zhang'], ['Darren Kim', 'Vien Yen Ho Pham', 'Corey Gibbel', 'Hitansh Nagdev'], ['Jacqueline Zhang', 'Jeremy Mui', 'Bradley Wei'], ['Conor Richard', 'Sarah Shin', 'Margaret Lee']], [['Tiffany Chung', 'Carl Qi', 'Kate Ngo'], ['Cyssi Ngo', 'Justin Quan', 'Jenny Bong'], ['Carrington Park', 'Tarun Sreedhar', 'Kai Chen'], ['Charles Van', 'Sydney Ty', 'Amy Zhong']]];
