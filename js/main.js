(function ($) {
	...
	var json = [[['Nicholas Paul', 'Ethan Yoon', 'Hannah Shever', 'Patricia Tse'], ['Carrington Park', 'Corey Gibbel', 'Junru Lyu', 'Jackie Hu'], ['Jacqueline Zhang', 'Hitansh Nagdev', 'Roger Zhang', 'Dylan Asprer'], ['Claire Yoon', 'Angela Jiang', 'Bradley Wei']], [['Emily Jin', 'Khoa Pham', 'Nina Tagliabue', 'Priscilla Chang'], ['Stella Kim', 'Jenny Bong', 'Kristy Kao'], ['Conor Richard', 'Kate Ngo', 'Celine Birkl'], ['Anthony Chen', 'Margaret Lee', 'Emily Zhu']], [['Tiffany Chung', 'Max Larsen', 'Grace Li', 'Monica Zhang'], ['Alan Dai', 'Cyssi Ngo', 'Christine Liu'], ['Samantha Fang', 'Tiffany Feng', 'Chloe Guo'], ['Sehee Park', 'Autumn Wang', 'Amy Zhong']], [['Brenton Law', 'George Lee', 'David Wang'], ['Kai Chen', 'Justin Quan', 'Vien Yen Ho Pham'], ['Jeremy Mui', 'Vaibhav Gattani', 'Janet Xu', 'Henry Cheong'], ['Grace Chi', 'Erika Yang', 'Sarah Shin']], [['Michelle Lin', 'Carl Qi', 'Kaci Gu'], ['Darren Kim', 'Cathy Zhang', 'Dennis Pham'], ['Charles Van', 'Christine Oh', 'Tarun Sreedhar'], ['Alice Chen', 'Brandy Nguyen', 'Sydney Ty']]];
