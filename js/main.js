(function ($) {
	...
	var json = [[['Nicholas Paul', 'David Wang', 'George Lee'], ['Corey Gibbel', 'Junru Lyu', 'Hannah Shever', 'Jenny Bong'], ['Jacqueline Zhang', 'Erika Yang', 'Amy Zhong'], ['Alice Chen', 'Brandy Nguyen', 'Claire Yoon']], [['Michelle Lin', 'Autumn Wang', 'Brenton Law', 'Khoa Pham'], ['Emily Zhu', 'Christine Liu', 'Kristy Kao'], ['Conor Richard', 'Kate Ngo', 'Priscilla Chang'], ['Alan Dai', 'Justin Quan', 'Sarah Shin']], [['Tiffany Chung', 'Grace Li', 'Max Larsen'], ['Jackie Hu', 'Tiffany Feng', 'Cathy Zhang', 'Carrington Park'], ['Samantha Fang', 'Celine Birkl', 'Tarun Sreedhar'], ['Sehee Park', 'Dylan Asprer', 'Janet Xu', 'Bradley Wei']], [['Henry Cheong', 'Vien Yen Ho Pham', 'Patricia Tse'], ['Anthony Chen', 'Monica Zhang', 'Hitansh Nagdev'], ['Emily Jin', 'Jeremy Mui', 'Chloe Guo'], ['Grace Chi', 'Angela Jiang', 'Christine Oh', 'Margaret Lee']], [['Carl Qi', 'Nina Tagliabue', 'Kaci Gu'], ['Darren Kim', 'Ethan Yoon', 'Vaibhav Gattani', 'Sydney Ty'], ['Cyssi Ngo', 'Charles Van', 'Kai Chen'], ['Stella Kim', 'Dennis Pham', 'Roger Zhang']]];
