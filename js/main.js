(function ($) {
	...
	var json = [[['Darren Kim', 'Emily Lu', 'Bianca Tam'], ['Brenton Law', 'Coco Sun', 'Ryan Fung', 'Andy Varela'], ['Nicholas Paul', 'Jason Tao', 'Milleno Pan'], ['Kai Chen', 'Nicole Kim', 'Jessica Wang']], [['Jackie Cai', 'James Yoo', 'Christine Liu', 'Monica Zhang'], ['Michelle Lin', 'Grace Chi', 'Charles Van'], ['Emily Zhu', 'Amy Zhong', 'Abby Tan'], ['Erika Yang', 'Autumn Wang', 'Conor Richard']], [['Alice Chen', 'Jaemin Woo', 'Ethan Chien'], ['Dennis Pham', 'Vien Yen Ho Pham', 'Hitansh Nagdev'], ['Henry Cheong', 'Nikita Rahman', 'Dyllan Liu'], ['Justin Quan', 'Hamayl Cheema', 'Alvin Han']], [['Austin Kim', 'Cathy Zhang', 'Carrie Liu'], ['Kaci Gu', 'Aman Patel', 'Liam Patel'], ['Bradly Wei', 'Albert Tran', 'Priscilla Chang'], ['Roger Zhang', 'Kate Ngo', 'Justin Kim']], [['Sydney Ty', 'Adam Sun', 'Hannah Shever'], ['Angela Jiang', 'Andrew Huang', 'Alexandre Lavoie', 'Maryam Kazi'], ['Jeremy Mui', 'Max Kim', 'Somi Kim'], ['Claire Yoon', 'Cassidy Cho', 'Edward Liu']]];
