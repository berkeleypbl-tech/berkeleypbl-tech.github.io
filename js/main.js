(function ($) {
	...
	var json = [[['Darren Kim', 'James Yoo', 'Alice Chen'], ['Roger Zhang', 'Christine Liu', 'Bianca Tam', 'Bradly Wei'], ['Brenton Law', 'Priscilla Chang', 'Hamayl Cheema', 'Hitansh Nagdev'], ['Justin Quan', 'Jaemin Woo', 'Jessica Wang']], [['Sydney Ty', 'Coco Sun', 'Cathy Zhang'], ['Michelle Lin', 'Vien Yen Ho Pham', 'Andy Varela'], ['Kate Ngo', 'Albert Tran'], ['Grace Chi', 'Ethan Chien', 'Tiffany Feng']], [['Austin Kim', 'Autumn Wang', 'Monica Zhang'], ['Jackie Cai', 'Aman Patel', 'Emily Lu'], ['Jeremy Mui', 'Andrew Huang', 'Dyllan Liu'], ['Kai Chen', 'Hannah Shever', 'Conor Richard']], [['Kaci Gu', 'Chloe Guo', 'Carrie Liu'], ['Angela Jiang', 'Amy Zhong', 'Somi Kim'], ['Abby Tan', 'Charles Van', 'Ryan Fung', 'Liam Patel'], ['Henry Cheong', 'Milleno Pan', 'Justin Kim']], [['Dennis Pham', 'Cassidy Cho', 'Nicole Kim', 'Nikita Rahman'], ['Nicholas Paul', 'Maryam Kazi', 'Alexandre Lavoie', 'Adam Sun'], ['Emily Zhu', 'Max Kim', 'Edward Liu'], ['Claire Yoon', 'Alvin Han', 'Erika Yang']]];
