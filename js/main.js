(function ($) {
	...
	var json = [[['Nicholas Paul', 'Nina Tagliabue', 'David Wang', 'Kaci Gu'], ['Alice Chen', 'Junru Lyu', 'Janet Xu', 'Roger Zhang'], ['Grace Chi', 'Sydney Ty', 'Erika Yang'], ['Brenton Law', 'Dylan Asprer', 'Claire Yoon']], [['Emily Jin', 'George Lee', 'Grace Li', 'Celine Birkl'], ['Kristy Kao', 'Cathy Zhang', 'Stella Kim'], ['Anthony Chen', 'Priscilla Chang', 'Jacqueline Zhang'], ['Emily Zhu', 'Chloe Guo', 'Angela Jiang']], [['Sehee Park', 'Max Larsen', 'Dennis Pham', 'Christine Oh'], ['Michelle Lin', 'Christine Liu', 'Hannah Shever'], ['Samantha Fang', 'Tiffany Feng'], ['Jackie Hu', 'Autumn Wang', 'Khoa Pham']], [['Henry Cheong', 'Patricia Tse', 'Ethan Yoon', 'Monica Zhang'], ['Darren Kim', 'Vien Yen Ho Pham', 'Corey Gibbel', 'Hitansh Nagdev'], ['Alan Dai', 'Jeremy Mui', 'Bradley Wei'], ['Conor Richard', 'Sarah Shin', 'Margaret Lee']], [['Tiffany Chung', 'Carl Qi', 'Kate Ngo'], ['Carrington Park', 'Justin Quan', 'Jenny Bong'], ['Cyssi Ngo', 'Tarun Sreedhar', 'Kai Chen'], ['Charles Van', 'Vaibhav Gattani', 'Amy Zhong', 'Brandy Nguyen']]];
